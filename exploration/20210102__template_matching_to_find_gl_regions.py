...
class TestPreproc_fun(TestCase):
    def test__find_channel_regions(self):
        ...
        for test in [tests[0]]:
            ...
            with self.subTest(test=test['name']):
                ...
                #     'pixel_size': 0.065,
                #     'gl_regions': [
                #         {'horizontal_range': [30, 565],
                #          'first_gl_position': 52,
                #          'gl_spacing': 105.75},
                #         {'horizontal_range': [840, 1410],
                #          'first_gl_position': 52,
                #          'gl_spacing': 105.75}
                #     ]
                # }

                path = '/home/micha/Documents/01_work/git/mmpreprocesspy/exploration/data/20210127_test_template_matching_to_find_gl_regions/test.json'
                self.write_template_config_to_json(converted_template_micron, path)
    ...
    #
    # test_template = {
    #     'template_image_path': './data/20210127_test_template_matching_to_find_gl_regions/16_thomas_20201229_glc_lac_1_MMStack.ome-1___template_v01_2.tif',
    #     'pixel_size': 0.065,
    #     'gl_regions': [
    #         {'horizontal_range': [30, 565],
    #          'first_gl_position': 52,

...
class TestPreproc_fun(TestCase):
    ...
    def test__36__bor_20230130__normalization_range_cutoffs(self):
        ...
        gl_detection_template_path = self.test_data_base_path + '/36__bor_20230130/GL_DETECTION_TEMPLATE/template_config.json'
        ...
        runner.preproc_fun(data_directory, directory_to_save, positions,
                           ...
                           normalization_range_detection_cutoffs=[0, 10000])
    ...
    def test__35__lis__20220320__repeat__manual_normalization_range(self):
        data_directory = self.test_data_base_path + '/35__lis__20220320__repeat/MMSTACK/20220320_VNG1040_AB2h_1_Frame0-478_resaved/'
        directory_to_save = self.test_data_base_path + '/35__lis__20220320__repeat/result_with_manual_normalization_range/'

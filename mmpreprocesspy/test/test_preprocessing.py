...
class TestPreprocessing(TestCase):
    ...
    def test__get_gl_regions_using_template(self):
        ...
        gl_rois = preprocessing.get_gl_rois_using_template(imdata, template, main_channel_angle=0)
    ...
    def test_create_growthlane_objects(self):
        ...
        regions = preprocessing.get_growthlane_rois([1, 20], 20, 50, parent_gl_region_id)
        pass
